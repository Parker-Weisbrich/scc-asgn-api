...
const Contact = require("./asgn-model");
...
exports.new = function (req, res) {
    ...
    contact.assignmentName = req.body.assignmentName;// ? req.body.name : contact.assignmentName;
...
exports.view = function (req, res) {
    Contact.findById(req.params.assignment_id, function (err, contact) {
        if (err) {
            res.send(err);
		}
        res.json({
